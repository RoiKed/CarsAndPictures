...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIViewController* carTableController = [[RKCarTableViewController alloc]initWithNibName:@"RKCarTableViewController" bundle:nil];
    self.navigationViewController = [[RKNavigationViewController alloc] initWithRootViewController:carTableController];
